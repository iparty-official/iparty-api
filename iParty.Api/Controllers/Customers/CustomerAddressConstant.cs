namespace iParty.Api.Controllers.Customers
{
    public class CustomerAddressConstant
    {
        ...
        public const string GetByIdDescription = "This is the method your app will use to show one specifi customer address. I can't see a scenario where this can be useful.";
